...
import Modal from '../components/Modal'; // ✅ adjust this path to where your Modal is
        ...
        {mobileMenuOpen && (
          <div className={landingPageStyles.mobileMenu}>
            <div className={landingPageStyles.mobileMenuContainer}>
              {user ? (
                <div className={landingPageStyles.mobileProfileCard}>
          ...
          <div className={landingPageStyles.featuresContainer}>
            <div className={ landingPageStyles.featuresHeader}>
              <h2 className={landingPageStyles.featuresTitle}>
                why choose us <span className={landingPageStyles.featuresTitleGradient}>
                  Resume🐧Xpert?
                </span>
              </h2>
              <p className={landingPageStyles.featuresDescription}>
                Everthing you need to create a proffesional resume that stands out.
              </p>
            </div>
      ...
      <footer className={landingPageStyles.footer}>
        <div className={landingPageStyles.footerContainer}>
          <p className={landingPageStyles.footerText}>
            ...
            <a href="https://portfolio-dj-rho.vercel.app/" target="_blank" className={landingPageStyles.footerLink}>
            DJ
            </a>
          </p> 
        </div>
