...
const EditResume = () => {
  ...
  //TAKE BACK TO PREVIOUS FORM STATE OR TAKE BACK TO FIRST OR TO
  const goBack = () => {
    const pages = [
      "profile-info",
      "contact-info",
  ...
  //UPDATE ARRAY ITEMS STATES USING INDEX
  ...
  //FETCHING THE RESUME DETAIS BY ID USING 
  ...
  // IT WILL HELP IN CHHOSING THE PREVIEW AS WELL AS HELP IN DOWNLOADING THE RESUME ALO SVES THE RESUME AS A RESUME
  ...
  //THIS FUNCTION RESUMEDEATAILS AS A THUMNAIL LINK
  ...
  //DELETE FUNCTION DELETE ANY RESUME
...
//HELP IN TO DOWNLOADING THE PDF
  const downloadPDF = async () => {
    ...
    //HOW IT WILL LOOK WHEN DOWNLOADED
    try {
      await html2pdf()
        .set({
          margin:       0,
...
//SO ALL THIS FUNCTION WILL WE USED FOR THE EDIT RESUME
// ALL THE CODE THAT 
              ...
              <div className={containerStyles.previewContainer}>
                ...
                <div className=' preview-container relative' ref={previewContainerRef}>
                  <div className={containerStyles.previewInner}>
                    <RenderResume key={`preciew-${resumeData?.template?.theme}`}
